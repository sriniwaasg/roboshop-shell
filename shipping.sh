...
cp /home/centos/roboshop-shell/shipping.ser /etc/systemd/system/shipping.service
...
mysql -h mysql-dev.sriniwaasg23.online -uroot -pRoboShop@1 < /app/schema/shipping.sql
